...
def main(args, model, state_dict):
    ...
    try:
        ...
        torch.save(model.state_dict(), '../My_model/model_perceptual.pt')
        pass
...
if __name__ == '__main__':
    ...
    try:
        state_dict = (torch.load('../My_model/model_perceptual.pt', weights_only=True))
    except:
        state_dict = None
